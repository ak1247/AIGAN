...
if __name__ == "__main__":
    ...
    pretrained_generator_path = './netG.pth'
    pretrained_G = models.Generator(image_nc).to(device)
    ...
    test_dataloader = DataLoader(mnist_dataset_test, batch_size=batch_size, shuffle=False, num_workers=1, drop_last=True)
    num_correct = 0
    num_all = 0
